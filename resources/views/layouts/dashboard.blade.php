                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									{{-- {{Auth::user()->image == null ? Avatar::create(Auth::user()->name)->toBase64() : Auth::user()->image}} --}}
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="{{route('category')}}">cateogory</a></li>
						</ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
                        ...
                        <ul aria-expanded="false">
							<li><a href="{{route('subcategory')}}">subcateogory</a></li>
						</ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Webstie</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="{{route('site')}}" target="_blank">site</a></li>
						</ul>
                    </li>
                </ul>
			</div>
