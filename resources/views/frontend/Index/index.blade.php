        ...
        <div class="row">
                    ...
                    <div class="killore--block-link-content">
                        <ul>
                            @foreach ($categories as $category)   
                                <li><a href="{{route('category.product', $category->id)}}"><img width="20" src="{{asset('uploads/category')}}/{{$category->category_image}}" alt="" class="mr-2">{{$category->category_name}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12">
                <div class="home-slider auto-slider mb-3 mt-3">
                    ...
                    <!-- Slide -->
                    <div data-background-image="{{asset('frontend_assets/img/light-banner-1.png')}}" class="item">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <!-- Slide -->
                    <div data-background-image="{{asset('frontend_assets/img/light-banner-2.png')}}" class="item">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="home-slider-container">
                    ...
                    <!-- Slide -->
                    <div data-background-image="{{asset('frontend_assets/img/light-banner-3.png')}}" class="item">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="home-slider-container">
...
<!-- ======================= Tag Wrap Start ============================ -->
<section class="bg-cover" style="background:url({{asset('frontend_assets/img/e-middle-banner.png')}}) no-repeat;">
    <div class="ht-60"></div>
    <div class="container">
        <div class="row justify-content-center">
            ...
            @foreach ($categories as $category)
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                    <div class="cats_side_wrap text-center mx-auto mb-3">
                        <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="{{route('category.product', $category->id)}}" class="d-block"><img src="{{asset('uploads/category')}}/{{$category->category_image}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12">
                <div class="reviews-slide px-3">
                    ...
                    <div class="single_review">
                        <div class="sng_rev_thumb"><figure>
                            @if ($product->image == null )
                                <img src="{{Avatar::create($product->rel_to_customer->name)->toBase64()}}" class="img-fluid circle" alt="" />
                            @else
                                <img src="{{asset('uploads/review')}}/{{$product->image}}" class="img-fluid circle" alt="" />
                            @endif
                        </figure></div>
                        <div class="sng_rev_caption text-center">
                            <div class="rev_desc mb-4">
                                @if ($product->review == null)
                                <p class="fs-md">No feedback given</p>
                                @else
                                <p class="fs-md">{{$product->review}}</p>
                                @endif
                            </div>
                            <div class="rev_author">
                                <h4 class="mb-0">{{$product->rel_to_customer->name}}</h4>
                            </div>
                        </div>
                    </div>
                        
                    @empty
                        <div class="alert alert-info">No review given yet</div>
                    @endforelse
...
<section class="space min">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="ftr-content">
                    ...
                    <div class="product_grid row">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                            <div class="shop_thumb position-relative">
                                <a class="card-img-top d-block overflow-hidden" href="{{route('product.details', $product->rel_to_product->slug)}}"><img class="card-img-top" src="{{asset('uploads/products/preview')}}/{{$product->rel_to_product->preview}}" alt="..."></a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                            <div class="text-left mfliud">
                                <div class="elso_titl"><span class="small">{{$product->rel_to_product->rel_to_category->category_name}}</span></div>
                                <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="shop-single-v1.html">{{$product->rel_to_product->product_name}}</a></h5>
                                <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                    
                                    @php
                                        $total_review = App\Models\OrderProduct::where('product_id', $product->product_id)->where('review', '!=', null)->count();
                                        $total_star = App\Models\OrderProduct::where('product_id', $product->product_id)->where('review', '!=', null)->sum('star');
                                ...
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">{{$product->rel_to_product->after_discount}} Tk</span></div>
                            </div>
                        </div>
                    </div>
                    @empty
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="ftr-content">
                    ...
                    <div class="product_grid row">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                            <div class="shop_thumb position-relative">
                                <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('uploads/products/preview')}}/{{$feat_product->preview}}" alt="..."></a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                            <div class="text-left mfliud">
                                <div class="elso_titl"><span class="small">{{$feat_product->rel_to_category->category_name}}</span></div>
                                <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="shop-single-v1.html">{{$feat_product->product_name}}</a></h5>
                                <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                    @php
                                ...
                                <div class="elis_rty">
                                    @if ($feat_product->product_discount != null)
                                        
                                    <span class="ft-bold text-dark fs-sm line-through mr-2">{{$feat_product->product_price}} Tk</span>
                                    <span class="ft-bold text-dark fs-sm">{{$feat_product->after_discount}} Tk</span>
                                    @else
                                    <span class="ft-bold text-dark fs-sm">{{$feat_product->after_discount}} Tk</span>
                                    @endif
                                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="ftr-title"><h4 class="ft-medium">Recently Viewed Products</h4></div>
                <div class="ftr-content">
                    @forelse ($recent_viewed_product->take(3) as $product)
                    ...
                    <div class="product_grid row">
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                            <div class="text-left mfliud">
                                <div class="elso_titl"><span class="small">{{$product->rel_to_category->category_name}}</span></div>
                                <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="shop-single-v1.html">{{$product->product_name}}</a></h5>
                                <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                    @php
                                        $total_review = App\Models\OrderProduct::where('product_id', $product->id)->where('review', '!=', null)->count();
                                        $total_star = App\Models\OrderProduct::where('product_id', $product->id)->where('review', '!=', null)->sum('star');
                                ...
                                <div class="elis_rty">
                                    <span class="ft-bold text-dark fs-sm line-through mr-1">{{$product->product_price}} Tk</span>
                                    <span class="ft-bold text-dark fs-sm">{{$product->after_discount}} Tk</span>
                                </div>
                                @endif
                            </div>
                        </div>
