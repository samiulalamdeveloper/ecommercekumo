								...
								<div class="dashboard_author px-2 py-5">
									<div class="dash_auth_thumb circle p-1 border d-inline-flex mx-auto mb-2">
                                        @if (Auth::guard('customerauth')->user()->image == null){
                                            <img src="{{Avatar::create(Auth::guard('customerauth')->user()->name)->toBase64()}}" class="img-fluid circle" width="100" alt="" />
                                        }
                                        @else{
                                            <img src="{{asset('uploads/customer')}}/{{Auth::guard('customerauth')->user()->image}}" class="img-fluid circle" width="100" alt="" />
                                        }
                                        @endif
									</div>
									<div class="dash_caption">
										<h4 class="fs-md ft-medium mb-0 lh-1">{{Auth::guard('customerauth')->user()->name}}</h4>
										<span class="text-muted smalls">{{Auth::guard('customerauth')->user()->country}}</span>
									</div>
								</div>
						...
						<div class="col-12 col-md-12 col-lg-8 col-xl-8 text-center">
							...
							<div class="ord_list_wrap border mb-4">
								<div class="ord_list_head gray d-flex align-items-center justify-content-between px-3 py-3">
                                    ...
                                    <div class="col-xl-3 col-md-3 col-lg-4 col-sm-6 col-3 ml-auto">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 ml-auto">
                                        ...
                                        <div class="delv_status"><span class="ft-medium small text-light bg-@php
                                            if($order->status == 0) {
                                                    echo 'success';
                                                } 
									...
									<div class="row align-items-center justify-content-center m-0 py-4 br-bottom">
										<div class="col-xl-12 col-lg-12 col-md-12 col-12">
											<div class="cart_single d-flex align-items-start mfliud-bot">
												<div class="cart_selected_single_thumb d-flex align-items-center justify-content-center">
													<a href="#"><img src="{{asset('uploads/products/preview')}}/{{$product->rel_to_product->preview}}" width="75" class="img-fluid rounded" alt=""></a>
												</div>
												<div class="cart_single_caption pl-3">
													...
													<p class="mb-2"><span class="text-dark medium">Size: {{$product->rel_to_size->size}}</span>, <span class="text-dark medium">Color: {{$product->rel_to_color->color_name}}</span></p>
													<h4 class="fs-sm ft-bold mb-0 lh-1">{{$product->rel_to_product->after_discount}} Tk X {{$product->quantity}}</h4>
												</div>
											</div>
										</div>
								...
								<div class="ord_list_footer d-flex align-items-center justify-content-between br-top px-3">
									<div class="col-xl-12 col-lg-12 col-md-12 pl-0 py-2 olf_flex d-flex align-items-center justify-content-between">
										...
										<div class="olf_inner_right"><h5 class="mb-0 fs-sm ft-bold">Total: {{$total}} Tk</h5></div>
									</div>
								</div>
							</div>
							<!-- End Order List -->
							@empty
							<h1 class="alert alert-danger">No Order is taken by you.</h1> 
							@endforelse
