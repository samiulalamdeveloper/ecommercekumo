                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        <div class="product_grid card b-0">
                            ...
                            <div class="badge bg-danger text-white position-absolute ft-regular ab-right text-upper">{{($wishlist->rel_to_product->product_discount == null) ? '': $wishlist->rel_to_product->product_discount}}</div>
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="{{route('product.details', $wishlist->rel_to_product->slug)}}"><img class="card-img-top" src="{{asset('uploads/products/preview')}}/{{$wishlist->rel_to_product->preview}}" alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footers b-0 pt-3 px-2 bg-white d-flex align-items-start justify-content-center">
                                <div class="text-left">
                                    <div class="text-center">
                                        ...
                                        <div class="elis_rty"><span class="ft-bold fs-md text-dark">{{$wishlist->rel_to_product->after_discount}} Tk</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @empty
                       <h1 class="alert alert-danger">No wishlist is added by you.</h1> 
                    @endforelse 
