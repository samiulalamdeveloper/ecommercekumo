									...
									<div class="row align-items-center">
										...
										<div class="col d-flex align-items-center justify-content-between">
											<div class="cart_single_caption pl-2">
												<h4 class="product_title fs-md ft-medium mb-1 lh-1">{{$cart->rel_to_product->rel_to_category->category_name}}</h4>
												<p class="mb-1 lh-1"><span class="text-dark">Size: {{($cart->size_id == null) ? 'NA' : $cart->rel_to_size->size}}</span></p>
							  ...
							  <div class="card-body">
								<ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
								  <li class="list-group-item d-flex text-dark fs-sm ft-regular">
									<span>Subtotal</span> <span class="ml-auto text-dark ft-medium">{{$subtotal}} Tk</span>
								  </li>
								  	@if ($type == 1)
										@php
									...
									@else
								  	...
								  	@endif
								  <li class="list-group-item d-flex text-dark fs-sm ft-regular">
									<span>Discount {{($type == 1)?'(%)':'(Tk)'}}</span> <span class="ml-auto text-dark ft-medium">{{$discount}} Tk</span>
								  </li>
								  <li class="list-group-item d-flex text-dark fs-sm ft-regular">
									<span>Total</span> <span class="ml-auto text-dark ft-medium">{{$total}} Tk</span>
								  </li>
