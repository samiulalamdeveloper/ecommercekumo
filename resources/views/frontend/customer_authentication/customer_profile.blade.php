            ...
            <div class="row align-items-start justify-content-between">
                    ...
                    <div class="d-block border rounded mfliud-bot">
                        ...
                        <div class="dashboard_author">
                            ...
                            <ul class="dahs_navbar">
                                ...
                                <li><a href="{{route('customer.profile')}}" class="active"><i class="lni lni-user mr-2"></i>Profile
                                        Info</a></li>
                ...
                <div class="col-12 col-md-12 col-lg-8 col-xl-8">
                    ...
                    <div class="row align-items-center">
                        <form class="row m-0" method="POST" action="{{route('customer.profile.update')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label class="small text-dark ft-medium">Name *</label>
                                    <input type="text" name="name" class="form-control" value="{{Auth::guard('customerauth')->user()->name}}" placeholder="Enter Name" />
                                    @error('name')
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" value="{{Auth::guard('customerauth')->user()->email}}" placeholder="Enter Email" />
                                    @error('email')
                                        <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
