			...
			<section class="middle">
				<div class="container">
					<div class="row align-items-start justify-content-between ">
						@auth('customerauth')
							<div class="m-auto">
								<h1 class="alert alert-danger m-auto">You have already logged in!</h1>
							</div>
						@else
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							...
							<form class="border p-3 rounded" method="POST" action="{{route('customer.login')}}">				
                                @csrf
								...
								<div class="my-3">
									<h3>Login with</h3>
									<div class="social-icon d-flex align-items-center justify-content-around">
										...
										<a href="{{route('google.redirect')}}" class="btn btn-outline-danger ms-1 me-1">
